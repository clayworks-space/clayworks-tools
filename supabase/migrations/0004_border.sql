-- Wraps the whole signature in a rounded #b97134 border, matching the
-- reference design.

update public.signature_templates
set html = '<table cellpadding="0" cellspacing="0" border="0" style="border:2px solid #b97134;border-radius:16px;">
  <tr>
